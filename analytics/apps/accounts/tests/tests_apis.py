...
from apps.accounts.serializers import UserNewSerializer, UserSerializer, AddressSerializer
...
class TestUserSerializer(TestCase):
    def setUp(self) -> None:
        user_data = {'username': 'reza', 'password': '1234567', 'email': 'reza@gamil.com'}
        admin_data = {'username': 'ehsan', 'password': '123456', 'email': 'ehsan@gmail.com'}
    ...
    def test_user_api_list(self):
        ...
        # See the diffrence between using 'reverse' from 'django.urls' or 'django-hosts':
        # django-hosts:
        from django_hosts.resolvers import reverse as rev
        response = self.client.get(rev('user-list', host='accounts'))
    ...
    def test_user_api_retreive(self):
        ...
        # MORE GENERIC API FOR EVERY API VIEW "LOOKUP_FIELD" WE WANT:
